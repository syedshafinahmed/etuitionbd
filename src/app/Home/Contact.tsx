...
import { FaGithub, FaGlobe, FaLinkedin, FaLinkedinIn } from "react-icons/fa";
import { TbBrandGithubFilled } from "react-icons/tb";

const Contact = () => {
  return (
    <section className="py-20 bg-white dark:bg-black text-black dark:text-white flex items-center justify-center px-6">
      <motion.div
      ...
      >
        ...
        <div className="space-y-6">
          ...
          <p className="text-sm md:text-xl text-black/70 dark:text-white/70 leading-relaxed text-justify">
            Have a question, need a tutor, or want to collaborate? Fill out the
